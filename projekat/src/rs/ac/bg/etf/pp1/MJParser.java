...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Feb 05 16:01:17 CET 2017
  */
			...
			switch (result.getKind()) {
				...
				case Obj.Meth:
					...
					if(parser.isStaticContext && !isStaticMethod(parser.currentClass, identifier)) {
						parser.semantic_error("tried to use non-static method \"" + identifier + "\" in static method \"" + parser.currentMethodName + "\".", line);
					} else {
