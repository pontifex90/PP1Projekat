...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Feb 11 04:56:39 CET 2017
  */
  ...
  public java_cup.runtime.Symbol scan()
	...
	public static void main(String[] args) throws Exception {
		...
		try {
	        ...
	        log.info("Global functions: " + p.globalFuncCount);
	        log.info("Class functions: " + p.classFuncCount);
	        log.info("Class static functions: " + p.classStaticFuncCount);
    ...
    public void syntax_error(Symbol cur_token) {
  	...
  	public void usage_info(Obj usedObject, String message, int line) {
  		String objectInfo = "";
  		if(usedObject != null) { 
  			objectInfo = " [ kind:" + usedObject.getKind() + "  name: " + usedObject.getName() +"  type: "+ usedObject.getType().getKind() +"]";
  		}
		report("Usage info on line " + line + ": " + message + objectInfo, null, LOG_TYPE.DEBUG);
	}
	...
	public void log_symbol_detected(Obj object, String message, int line) {
		String objectInfo = "";
		if(object != null) {
			objectInfo = " [ kind: " + object.getKind() + "  name: " + object.getName() +"  type: "+ object.getType().getKind() +"]";
		}	
		
		semantic_info(message + objectInfo, line);
	}
...
class CUP$MJParser$actions {
	...
	private boolean hasMethodAppropriateParams(Obj methodObject, Stack<Struct> actualParams, int line) {
		if(methodObject == null || actualParams == null) { return false; }
