...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Feb 05 15:00:35 CET 2017
  */
...
class CUP$MJParser$actions {
	...
	private Obj findClassMemberWithName(Obj classObj, String identifier, int line) {
		...
		if(classObj == parser.currentClass) {
			...
			if(classObj.getKind() == Obj.Type) {
				if(result.getKind() != Obj.Meth || !isMethodStatic(classObj, identifier)) {
	...
	private boolean isMethodStatic(Obj classObject, String identifier) {
	...
	private Obj addMethodToSymbolTable(String name, int line) {
		...
		if(isMethodStatic(parser.currentClass, name)) {
