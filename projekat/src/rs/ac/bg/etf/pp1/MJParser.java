...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Feb 11 03:32:03 CET 2017
  */
  ...
  public java_cup.runtime.Symbol scan()
    ...
    public void syntax_error(Symbol cur_token) {
  	...
  	public void usage_info(Obj usedObject, String message, int line) {
  		String objectInfo = " [ kind:" + usedObject.getKind() + "  name: " + usedObject.getName() +"  type: "+ usedObject.getType().getKind() +"]";
	...
	public void log_symbol_detected(Obj object, String message, int line) {
		String objectInfo = " [ kind: " + object.getKind() + "  name: " + object.getName() +"  type: "+ object.getType().getKind() +"]";
