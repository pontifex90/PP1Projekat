...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Feb 09 04:01:12 CET 2017
  */
		...
		Stack<Struct> params = (Stack<Struct>)((java_cup.runtime.Symbol) CUP$MJParser$stack.peek()).value;
				...
				if(params == null && isObjectVariable(des, desleft))
				{
					...
					if(des.getKind() != Obj.Elem) {
						// For arrays, we can't do load because it would affect index and address values on stack before we duplicated them.
						Code.load(result);
					}
